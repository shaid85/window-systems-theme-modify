...
<div class="max-w-[1440px] container px-4 py-10 md:p-[80px] mx-auto">
  ...
  <header class="flex items-start gap-[24px] mb-[56px] flex-start">
    ...
    <div class="flex flex-col gap-[16px]">
      <h1 class=" text-[#000000] text-[40px] font-[400] leading-[48px] font-Erbaum flex gap-[12px]">
        <div class="block md:hidden w-[20px] flex-shrink-0">
          <svg width="20" height="48" viewBox="0 0 20 48" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
              d="M3.1405 48L0 44.7691L12.2865 32.1291C14.3985 29.9563 15.5556 27.075 15.5556 23.9953C15.5556 20.9156 14.3893 18.0342 12.2865 15.8709L0 3.23086L3.1405 0L15.427 12.64C18.3747 15.6725 20 19.7064 20 23.9953C20 28.2842 18.3747 32.318 15.427 35.3505L3.1405 47.9906V48Z"
              fill="#FFCC32" />
...
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.";
  ...
  <!-- Hero Section -->
  <section class="hidden md:flex gap-[56px] mb-[56px] bg-[#f7f7f7] rounded-[16px] min-h-[560px]">
    <?php
    ...
    if ($recent_post->have_posts()):
      while ($recent_post->have_posts()):
        ...
        <div class="flex flex-col justify-between w-1/2 rounded-l-[16px] p-[24px]">
          <h3 class="text-[#6B6B6B] text-[12px] font-semibold uppercase mb-2 min-h-[150px] pt-[8px]">INTERJERO IDĖJOS</h3>
          <div class="my-[48px] flex flex-col gap-[16px]">
            ...
            <div class="flex items-center mb-6">
              <div class="ml-3">
                <p class="font-bold font-degular-regular"><?php the_author(); ?></p>
                <p class="text-[#7f7f7f] text-[16px] font-degular-regular">Langų sistemų interjero ekspertė</p>
              </div>
            </div>
          </div>
          <a href="<?php the_permalink(); ?>"
            class="w-[300px] mb-[8px] flex items-center justify-center p-[16px] text-black font-semibold bg-[#ffcc32] transition-colors rounded-[16px]">
            Skaityti straipsnį
  ...
  <?php if ($posts_query->have_posts()): ?>
    <div class="grid grid-cols-1 gap-[24px] md:grid-cols-2 lg:grid-cols-3">
      <?php while ($posts_query->have_posts()):
        ...
        <?php if ($i != 0): ?>
          <article
            class="single-post post-type-post overflow-hidden transition duration-300 bg-[#f7f7f7] rounded-[16px] hover:shadow-lg">
            <a href="<?php the_permalink(); ?>">
              <?php if (has_post_thumbnail()): ?>
                <img src="<?php the_post_thumbnail_url(); ?>" alt="<?php the_title(); ?>"
                 class="md:min-h-[320px] object-cover w-full h-[200px] md:h-48">
              <?php endif; ?>
              <div class="p-5 flex flex-col gap-[16px] pt-0 pb-[20px]">
                <div class="">
                  <?php
    ...
    <!-- Pagination -->
    <div class="flex items-center justify-center mt-10 gap-[16px]">
      <?php
      echo paginate_links([
        'mid_size' => 1,
        ...
        'before_page_number' => '<span class="inline-flex items-center justify-center w-[48px] h-[48px] rounded-[16px] cursor-pointer  text-sm font-bold p-[20px] font-degular-text-bold">',
