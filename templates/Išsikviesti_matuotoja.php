<!-- Creating a Template for get a quote ... -->

<?php

    /**
     * Template name: Išsikviesti matuotoja
     */
...
<div  class="bg-[#F7F7F7]">
    <style>
      form > p:nth-child(3) > span > span > span.wpcf7-list-item > label > span {
        all: unset;
        font-size: 16px;
        line-height: 24px;
...
<section class="flex md:flex-row flex-col max-w-[1440px] w-full  mx-auto md:py-[56px] md:px-[80px] md:gap-[56px] px-[16px] py-[40px] gap-[24px] bg-[#F7F7F7]">
    <!-- left container -->
    <div class="flex gap-[48px] flex-col w-full md:w-[584px]">
        <div class="flex flex-col   gap-[16px]">
            <h1 class="md:text-[40px] text-[28px] md:leading-[48px] leading-[32px] font-[400] font-Erbaum text-[#000000]">Išsikviesti matuotoją</h1>
            <?php
                    $post_type = 'matuotoja';
    ...
    <div class="flex md:hidden flex-col md:gap-[24px] gap-[16px] md:p-[24px] p-[16px] rounded-[16px] bg-[#000000]">
           <p class="text-[18px] leading-[26px] font-[400] font-degular-var text-[#ffffff]">“Lorem ipsum dolor sit amet consectetur. Dui accumsan convallis viverra eu dignissim. Ut phasellus ut duis auctor. Nulla amet augue cursus ullamcorper enim. Eu urna quis tincidunt imperdiet fermentum.”</p>
           <div class="flex gap-[16px] items-center">
               <img class="rounded-[1000px] h-[56px] w-[56px] " src="<?php echo LANGU_THEME_URI ?>/assets/images/Frame1214136332(2).png" alt="">
              <div class="flex flex-col gap-[8px]">
                   <div class="flex flex-col gap-[1px]">
                       <h3 class="text-[16px] leading-[24px] text-[#ffffff] font-degular-bold">Olivia Gardens</h3>
                       <p class="text-[16px] leading-[24px] font-[400] font-degular-var text-[#BEBEBE]">Lorem ipsum dolor</p>
                   </div>
                   <div class="flex gap-[8px]">
                       <?php for ($i = 0; $i < 5; $i++) {?>
                           <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
